            ...
            <div className="p-6 border-b border-white/5">
                <div className="flex items-center gap-3 mb-1">
                    ...
                    <h1 className="text-lg font-bold tracking-tight text-white">
                        {appName} <span className="text-cyan-400 drop-shadow-[0_0_5px_rgba(34,211,238,0.5)]">{appSubtitle}</span>
                    </h1>
                </div>
                ...
                <div className="mb-6">
                    ...
                    {communities.map(community => (
                        ...
                        >
                            ...
                            <div className={`w-10 h-10 rounded-full overflow-hidden shrink-0 border-2 transition-colors ${activeCommunityId === community.id ? 'border-cyan-500 shadow-lg shadow-cyan-500/20' : 'border-white/5 group-hover:border-white/10'
                                }`}>
                    ...
                    <button
                        ...
                        className="w-full mt-2 p-2 rounded-lg border border-dashed border-slate-700 hover:border-indigo-500/50 hover:bg-indigo-500/5 text-slate-500 hover:text-indigo-400 transition-all flex items-center justify-center gap-2 text-xs font-medium group"
                    >
                    ...
                    {contacts && contacts.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-6 text-slate-500 space-y-2 border border-dashed border-slate-800 rounded-xl bg-slate-900/30">
                            ...
                            <div className="text-center">
                                <p className="text-xs font-medium text-slate-400">No messages</p>
                            </div>
                        </div>
                    )}
